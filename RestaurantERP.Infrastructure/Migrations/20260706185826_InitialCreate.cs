        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierLedger_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UiPageBlocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UiPageBlocks_UiPages_PageId",
                        column: x => x.PageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GRNItem", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GRNItem_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommissionLedgers_CommissionRules_CommissionRuleId",
                        column: x => x.CommissionRuleId,
                        principalTable: "CommissionRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommissionLedgers_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommissionLedgers_Settlement_SettlementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_KitchenStations_KitchenStationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionLedgers_CommissionRuleId",
                table: "CommissionLedgers",
                column: "CommissionRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionLedgers_OrderId",
                table: "CommissionLedgers",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionLedgers_SettlementId",
                table: "CommissionLedgers",
                column: "SettlementId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NavigationMenus_MenuKey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_KitchenStationId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UiPageBlocks_PageId",
                table: "UiPageBlocks",
                column: "PageId");

            migrationBuilder.CreateIndex(
                name: "IX_UiPages_Slug",
                table: "UiPages",
                column: "Slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_UserId_MenuItemId",
                table: "WishlistItems",
